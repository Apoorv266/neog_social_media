...
const ModalList = ({item, isUserFollowed}) => {
  ...
  return (
    <div className='followList-Main'>
         <img src={userData?.username === item?.username  ? userData?.avatarUrl: item.avatarUrl} alt="" width={"50px"} height={"50px"} style={{ borderRadius: "50%", backgroundSize: "cover", objectFit: "cover" }} />
